 ...
 * @Date: 2022-08-25 23:34:59
 * @LastEditors: songyx 2250794569@qq.com
 * @LastEditTime: 2022-08-25 23:35:05
 * @FilePath: \jade-cloud\video-server\src\main\java\com\jade\video\stream\Stream2Image.java
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */
package com.jade.video.stream;
...
public class Stream2Image {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String url = "D:\\01-GS\\video\\qq.mp4";

        // 完整图片存放路径，注意文件名是当前的年月日时分秒
        String localPath = "D:\\01-GS\\video\\pic\\" + new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) + ".jpg";
