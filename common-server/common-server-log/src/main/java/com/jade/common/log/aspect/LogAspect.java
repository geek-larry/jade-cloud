package com.jade.common.log.aspect;
...
import com.jade.common.log.constant.BusinessStatus;
import com.jade.common.log.service.AsyncLogService;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            String username = JwtUtil.getUserName(TokenUtil.getToken(ServletUtil.getRequest()));
     ...
     */
    @SneakyThrows
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysLogOper operLog, Object jsonResult) {
        // 设置action动作
     ...
     * @param operLog 操作日志
     */
    private void setRequestValue(JoinPoint joinPoint, SysLogOper operLog) {
